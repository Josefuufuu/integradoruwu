...
DATABASES = {
    'default': {
        ...
        'NAME': 'bienestar_universitario',  # Nombre de la base de datos en PostgreSQL
        'USER': 'postgres',  # Tu usuario de PostgreSQL
        'PASSWORD': 'jd122005',  # Tu contraseña de PostgreSQL
        'HOST': 'localhost',  # Si estás en tu máquina local
